window.onload=function(){
    ...
    function createMap(){
        ...
        var point = new BMap.Point(113.302235,23.079651);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"今驰卫浴建材有限公司",content:"我的备注",point:"113.30241|23.080174",isOpen:0,icon:{w:23,h:25,l:46,t:21,x:9,lb:12}}
         ];
    //创建marker
    function addMarker(){
